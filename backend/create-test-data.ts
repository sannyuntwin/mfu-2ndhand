...
async function main() {
  ...
  const product2 = await prisma.product.upsert({
    ...
    create: {
      ...
      price: 1099.99,
      imageUrl: 'https://via.placeholder.com/500x500?text=MacBook+Air+M3',
      sellerId: seller1.id,
    },
  });
  ...
  const product3 = await prisma.product.upsert({
    ...
    create: {
      ...
      price: 39.99,
      imageUrl: 'https://via.placeholder.com/500x500?text=Clean+Code+Book',
      sellerId: seller2.id,
    },
  });
  ...
  const product4 = await prisma.product.upsert({
    ...
    create: {
      ...
      price: 199.99,
      imageUrl: 'https://via.placeholder.com/500x500?text=Bluetooth+Headphones',
      sellerId: seller2.id,
    },
  });
  ...
  const product5 = await prisma.product.upsert({
    ...
    create: {
      ...
      price: 29.99,
      imageUrl: 'https://via.placeholder.com/500x500?text=Organic+Cotton+T-Shirt',
      sellerId: seller2.id,
    },
  });
